...
@section('content')
    <div class="max-w-2xl mx-auto p-4 space-y-6">
        <h1 class="text-2xl font-bold">Buat Buku Baru</h1>
        ...
        <form action="{{ route('admin.books.store') }}" method="post" enctype="multipart/form-data" class="space-y-4">
            ...
            <fieldset class="fieldset">
                ...
                <input type="text" name="title" class="input w-full @error('title') border-error @enderror" value="{{ old('title') }}" placeholder="Contoh: Laskar Pelangi" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="text" name="author" class="input w-full @error('author') border-error @enderror" value="{{ old('author') }}" placeholder="Nama Penulis" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="number" name="price" class="input w-full @error('price') border-error @enderror" value="{{ old('price') }}" placeholder="50000" />
                ...
                <fieldset class="fieldset">
                    ...
                    <input type="number" name="stock" class="input w-full @error('stock') border-error @enderror" value="{{ old('stock') }}" placeholder="10" />
            ...
            <fieldset class="fieldset">
                ...
                <textarea name="description" class="textarea w-full h-24 @error('description') border-error @enderror" placeholder="Sinopsis buku...">{{ old('description') }}</textarea>
