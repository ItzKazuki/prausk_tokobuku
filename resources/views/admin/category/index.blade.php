    ...
    <div class="space-y-4">
        ...
        <div class="flex justify-between">
            ...
            <div class="flex flex-row gap-4">
                <form method="get">
                    <input type="text" name="search" placeholder="Cari kategori, ex: novel" class="input" />
                </form>

                <a class="btn btn-info" href="{{ route('admin.categories.create') }}">Buat Kategori Baru</a>
            </div>
        </div>
                ...
                <tbody>
                    @forelse ($categories as $category)
                        <tr>
                            <td>{{ $category->name }}</td>
                            <td class="space-y-2">
                                <a href="{{ route('admin.categories.edit', ['category' => $category->id]) }}" class="btn btn-xs btn-warning">update</a>
