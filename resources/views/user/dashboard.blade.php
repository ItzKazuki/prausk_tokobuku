...
@section('content')
    <div class="container mx-auto px-4 space-y-12 py-8">
        ...
        <div>
            ...
            <p>selamat datang di kabuku, platform jual beli buku yang terpercaya di Indonesia!</p>
        </div>
        ...
        <div>
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('user.book.index') }}"
                    class="link link-primary no-underline hover:underline font-semibold">Lihat Semua</a>
            </div>
